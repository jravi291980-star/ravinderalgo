...
# --- FIX: Correctly import Context from dhanhq.models and alias it to DhanContext ---
# The top-level dhanhq package does not expose DhanContext directly.
from dhanhq.models import Context as DhanContext 
...
    """Initializes and returns the Dhan REST client."""
    try:
        # DhanContext is now correctly imported from dhanhq.models and aliased
        dhan_context = DhanContext(client_id, access_token)
        # dhanhq() function is used to instantiate the client
        return dhanhq(dhan_context) 
    except Exception as e:
