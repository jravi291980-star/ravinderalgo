...
REDIS_TRADE_UPDATE_CHANNEL = 'dhan_trade_updates'# Algo Engine -> Web Engine

# Status Keys (Used by Web Engine to monitor Worker health)
...
# --- DHAN API CONFIGURATION KEYS (Retrieved from DB/Environment) ---
